...
const Fairs = ({services}) => {

   const{id,image,short_description,name,price,button_text}=services;
        return (
           
          
            
            <div className="card card-compact bg-base-100 shadow-xl pl-2  pr-2 m-5 md:m-2 py-16 ">
