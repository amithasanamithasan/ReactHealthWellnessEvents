...
import image from"../../../assets/contactlogo.jpeg"
            ...
            <div className="max-w-6xl mx-auto bg-[#2e0249] rounded-lg">
                <div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <p className="text-sm text-gray-400 mt-3">Have some big idea or brand to develop and need help? Then reach out wedont love to hear about your project  and provide help.</p>
                    ...
                    <div className="bg-gray-200 p-6 rounded-lg">
                        ...
                        <div className="space-y-4 max-lg:mt-4">
                            <button type="button" className="px-4 py-2 rounded-md bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Health Fairs</button>
                            <button type="button" className="px-4 py-2 rounded-md bg-transparent text-gray-400 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">Yoga and Fitness Retreats</button>
                            <button type="button" className="px-4 py-2 rounded-md bg-transparent text-gray-400 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Health & Wellness Expos</button>
                        </div>
                ...
                <div className="z-10 relative h-80 w-95 max-md:min-h-[350px] ">
